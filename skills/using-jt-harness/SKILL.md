...
- Use `superpowers:receiving-code-review` to assess findings. Resolve actionable findings, verify fixes, and inspect changes since the reviewed head. Do not trigger incremental reviews or request a second complete Codex or CodeRabbit review after new commits.
